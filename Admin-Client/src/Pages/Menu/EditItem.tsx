...
export default function EditItem(){
  ...
  const putItem = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()

    try {
      const response = await fetch(`${API}/itemAdmin/Update/${addItemForm.name}`, {
        method: "PUT",
        headers: {
  ...
  return(
    <SidebarProvider>
      ...
      <main className="relative w-full space-y-6 p-6">
        <h1 className="mt-4 text-center text-3xl font-bold lg:text-4xl">BB Food Cart | Edit Items</h1>
        ...
        <div className="container mx-auto py-10">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Edit item from the menu: </CardDescription>
            </CardHeader>
