...
namespace Backend.HelperFunctions
{
    ...
    public class Calories
    {
        ...
        public enum UserActivityLevel
        {
            ...
            ModeratelyActive,           //Light to moderate exercise 4-5 days a week
            Active,                     //Moderate exercise 6 to 7 days/week or intense exercise 3 to 4/week
            VeryActive                 //Physical job or intense training, intense exercise 6 to 7 times/week
        }
        public static double calculateBMR(double weightInKg, double heightInCm, bool IsMale, int age, UserActivityLevel activityLevel, int UserTrainingTarget, int alreadyKnowCalories = 0)
        {
